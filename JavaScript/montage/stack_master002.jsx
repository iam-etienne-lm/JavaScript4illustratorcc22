...
//CODE
var scriptID = "stack_master v1.0";
var fileType = "*.pdf";
opentwinfolder();

function opentwinfolder(){
daoFolder = Folder ("C:/TEMPai/y.test/input/dao");								//y.test or F5
impFolder = Folder ("C:/TEMPai/y.test/input/imp");	
var files1 = [];
var files2 = [];
files1 = daoFolder.getFiles( fileType );
files2 = impFolder.getFiles( fileType );
outputFile = File("C:/TEMPai/F5/output/1.pdf");
