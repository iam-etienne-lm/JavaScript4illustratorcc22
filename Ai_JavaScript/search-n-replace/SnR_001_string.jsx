...
var files1  = null;
var sourceDoc1  = null;
var sourceFolder1 = Folder ("S:/Articles/Espace Travail/312/312817-xx SUMMER THE SWAN/W/DAO/312317-10A DAO");
var fileType = "*.pdf";
...
function save_thesefiles(){
//for ( i = 0; i < files1.length; i++ ){
    //var sourceDoc1 = app.open(files1[i]);
sourceDoc1.close(SaveOptions.SAVECHANGES);

}	

function close_thesefiles(){
for ( i = 0; i < files1.length; i++ ){
    var sourceDoc1 = app.open(files1[i]);
